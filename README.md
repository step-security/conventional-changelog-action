...
- **Optional** `preset`: Preset that is used from conventional commits. Default is `angular` ([learn more about presets here](https://github.com/step-security/conventional-changelog-action/issues/223))
